...
export const STR: Record<Lang, Strings> = {
  en: {
    ...
    settings: {
      ...
      presetBalancedDesc: "Conversation runs locally for speed; coaching, content generation, and assessment use Claude for quality.",
      presetHighQuality: "Best quality",
      presetHighQualityDesc: "Every role uses Claude, the tested baseline.",
      presetLocalRequired: "Set up a local LLM connection in the Connections tab to enable the local presets.",
      presetCustom: "Custom",
      ...
      targetLocal: "Local",
      targetCodex: "Codex",
      targetLocalDisabled: "Set up a local LLM connection in the Connections tab to choose Local.",
  ...
  ja: {
    ...
    settings: {
      ...
      presetBalancedDesc: "会話はローカルで速さを、コーチング・教材生成・測定は品質を優先して Claude を使います。",
      presetHighQuality: "最高品質",
      presetHighQualityDesc: "すべての用途を Claude（動作確認済みの基準）で動かします。",
      presetLocalRequired: "「接続」タブでローカル LLM の接続先を設定すると、ローカルを使うプリセットが選べます。",
      presetCustom: "カスタム",
      ...
      targetLocal: "ローカル",
      targetCodex: "Codex",
      targetLocalDisabled: "「接続」タブでローカル LLM の接続先を設定すると「ローカル」を選べます。",
