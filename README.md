...
音読ウォームアップ → 4/3/2 → ロールプレイ → シャドーイング → 振り返り、の5ブロック通し練習。振り返りでは、その通し練習に属する発話だけを日付境界を跨いでも順序どおりに集め、AI が改善ポイントをまとめます。ブロック完了XPの記録に失敗しても練習はそのまま続けられ、画面上の情報表示から同じ記録を安全に再試行できます。
