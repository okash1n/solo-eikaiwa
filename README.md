...
3. 初回起動時、音声認識（whisper）モデルのダウンロード案内バナーが表示されます。**推奨の large-v3-turbo（1.6GB・現行と同じ精度）**または**軽量な small（約0.5GB・低スペック機向け・精度はやや下がります）**を選んでダウンロードしてください。中断しても再開でき、完了時にチェックサムを検証します
